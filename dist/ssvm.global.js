...
(() => {
  ...
  var require_Gradule_web2 = __commonJS2({
    "src/Gradule-web.js"(exports2, module2) {
      ...
      var _exp_ = { print: print2, printE, printWithStyles, input, beautify, preset: Preset };
    ...
    "src/wosscript.js"(exports, module) {
      ...
      var require_Gradule_web = __commonJS({
        "src/Gradule-web.js"(exports2, module2) {
          ...
          var _exp_ = { print: print2, printE, printWithStyles, input, beautify: beautify2, preset: Preset };
          if (typeof module2 !== "undefined") {
